        ...
        <div class="row">
            <div class="swiper-container swiper-container-horizontal">
                <div class="swiper-wrapper"
                    style="transform: translate3d(-1760px, 0px, 0px); transition-duration: 0ms;">
                    ...
                    <div class="swiper-slide">
                        <div class="pa-tesimonial-box">
                            ...
                            <div class="pas-testi-content">
                                <h2> Ravi Shankar</h2>
                                <p>Amolax Oil from Natural-Ayurveda-Tips has been a lifesaver for my chronic joint pain.
                                    Its anti-inflammatory properties provide quick relief without any side effects. I
                                    can't thank them enough for this wonderful product!</p>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="pa-tesimonial-box">
                            ...
                            <div class="pas-testi-content">
                                <h2>Nikhil Maurya</h2>
                                <p>Pyolax Capsule has truly been a blessing in managing my piles. Thanks to
                                    Natural-Ayurveda-Tips, I found relief from the discomfort and pain associated with
                                    piles. Highly recommend it to anyone suffering from similar issues.</p>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="pa-tesimonial-box">
                            ...
                            <div class="pas-testi-content">
                                <h2>Vikram Singh</h2>
                                <p>Ashcrush Capsule helped me pass kidney stones smoothly and painlessly.
                                    Natural-Ayurveda-Tips' herbal formulation is gentle yet effective. I'm grateful for
                                    their product which spared me from surgical intervention.</p>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="pa-tesimonial-box">
                            ...
                            <div class="pas-testi-content">
                                <h2>Kavita Sharma</h2>
                                <p>Pawan Muskt churan has become my go-to remedy for stomach pain and acidity. It's
                                    gentle on my system and provides quick relief. Natural-Ayurveda-Tips has really
                                    nailed it with this product!</p>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="pa-tesimonial-box">
                            ...
                            <div class="pas-testi-content">
                                <h2>Meera Jain</h2>
                                <p>FEMX Gold Capsule has been a game-changer for my persistent issue with leukorrhea.
                                    Thanks to Natural-Ayurveda-Tips, I finally found a natural solution that works
                                    wonders without any side effects. I'm thrilled with the results!</p>
                            </div>
                        </div>
                    </div>
                </div>
